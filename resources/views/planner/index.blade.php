...
@section('localscript')
  <!-- fullCalendar 2.2.5-->
  <link rel="stylesheet" href="{{ URL::asset('/admin/plugins/fullcalendar/fullcalendar.min.css') }}">
  <link rel="stylesheet" href="{{ URL::asset('/admin/plugins/fullcalendar/fullcalendar.print.css') }}" media="print">
  <!-- Theme style -->
        ...
        <div class="col-md-3">
          <div class="box box-solid">
            <div class="box-header with-border">
              <h4 class="box-title">1 Draggable Events</h4>
            </div>
            <div class="box-body">
              <!-- the events -->
